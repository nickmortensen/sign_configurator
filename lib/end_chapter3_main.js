...
function getSpotLight(intensity) {
	...
	light.castShadow = true;
	light.shadow.bias = 0.01; //controls the shadow artifacting
	light.shadow.mapSize.width = 2048; //defaults to 1024
	light.shadow.mapSize.height = 2048;  //defaults to 1024
	return light;
}	// getSpotLight
